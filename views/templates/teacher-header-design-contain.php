    ...
    <section class="vbox">
        <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
            <div class="navbar-header aside-md dk">
                ...
                <a href="teacher-dashboard.php" class="navbar-brand"> <img src="../../assets/images/H1.png" class="m-r-sm" alt="scale"> <span class="hidden-nav-xs">Hogward School</span> </a>
                            ...
                            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                ...
                                <nav class="nav-primary hidden-xs">
                                    ...
                                    <ul class="nav nav-main" data-ride="collapse">
                                        <li class="active">
                                            <a href="teacher-dashboard.php" class="auto"> <i class="fa fa-home"> </i> <span class="font-bold">Dashboard</span> </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <b class="badge bg-danger pull-right"></b> <i class="i i-stack icon"> </i> <span class="font-bold">Class Information</span> </a>
                                            <ul class="nav dk">
                                                <li>
                                                    <a href="add-new-class.php" class="auto"> <i class="i i-dot"></i> <span>Add New Class</span> </a>
                                                </li>
                                                <li>
                                                    <a href="view-all-class.php" class="auto"> <i class="i i-dot"></i> <span>View All Class</span> </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="">
                                            <a href="teacher-dashboard.php" class="auto"> <i class="i i-logout"> </i> <span class="font-bold">Logout</span> </a>
                                        </li>
                                    </ul>
                                </nav>
                                <!-- / nav -->
