                            ...
                            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                ...
                                <nav class="nav-primary hidden-xs">
                                    ...
                                    <ul class="nav nav-main" data-ride="collapse">
                                        <li class="active">
                                            <a href="admin-dashboard.php" class="auto"> <i class="fa fa-home"> </i> <span class="font-bold">Dashboard</span> </a>
                                        </li>
                                        <li>
                                            ...
                                            <ul class="nav dk">
                                                <li>
                                                    <a href="add-new-admin.php" class="auto"> <i class="i i-dot"></i> <span>Add New Admin</span> </a>
                                                </li>
                                                <li>
                                                    <a href="view-all-admin.php" class="auto"> <i class="i i-dot"></i> <span>View All Admin</span> </a>
                                                </li> 
                                            </ul>
                                        </li>
                                        <li>
                                            ...
                                            <ul class="nav dk">
                                                <li>
                                                    <a href="add-new-teacher.php" class="auto"> <i class="i i-dot"></i> <span>Add New Teacher</span> </a>
                                                </li>
                                                <li>
                                                    <a href="view-all-teacher.php" class="auto"> <i class="i i-dot"></i> <span>View All Teacher</span> </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <b class="badge bg-danger pull-right"></b> <i class="i i-stack icon"> </i> <span class="font-bold">Accounts Information</span> </a>
                                            <ul class="nav dk">
                                                <li>
                                                    <a href="add-new-accounts.php" class="auto"> <i class="i i-dot"></i> <span>Add New Accounter</span> </a>
                                                </li>
                                                <li>
                                                    <a href="view-all-accounts.php" class="auto"> <i class="i i-dot"></i> <span>View All Accounter</span> </a>
                                                </li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav dk">
                                                <li>
                                                    <a href="add-new-staff.php" class="auto"> <i class="i i-dot"></i> <span>Add New Staff</span> </a>
                                                </li>
                                                <li>
                                                    <a href="view-all-staff.php" class="auto"> <i class="i i-dot"></i> <span>View All Staff</span> </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="">
                                            <a href="admin-dashboard.php" class="auto"> <i class="fa fa-credit-card"> </i> <span class="font-bold">Payment</span> </a>
                                        </li>
                                        <li class="">
                                            <a href="admin-dashboard.php" class="auto"> <i class="fa fa-gears"> </i> <span class="font-bold">Settings</span> </a>
                                        </li>
                                        <li class="">
                                            <a href="admin-dashboard.php" class="auto"> <i class="i i-logout"> </i> <span class="font-bold">Logout</span> </a>
                                        </li>
                                    </ul>
                                </nav>
                                <!-- / nav -->
