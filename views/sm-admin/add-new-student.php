                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $email_check = $StudentManagement -> emailCheck($email);
                                            ...
                                            {
                                                $data = $StudentManagement -> AddStudent($first_name,$last_name,$email,$password,$contact,$unique_image_name);

                                                move_uploaded_file( $image_tmp_name, '../../assets/images/'. $unique_image_name);
                                                if($data == true)
                                                {
                                                    $mess = "<p class='alert alert-success'>A New Student Added! !<button class='close' data-dismiss='alert'>&times;</button></p>";
                                                }
                                            }
                                        }
                                    ?>
