    ...
    <section class="vbox">
        <section class="scrollable padder">
            <section class="row m-b-md">
                <div class="col-sm-6">
                    <h3 class="m-b-xs text-black">All Accounts Data</h3> <small>Welcome back, John Smith</small> </div>
            </section>
                ...
                <div class="col-md-12 dker">
                    <section>
                        <div class= "main-section" style=" width:800px; margin:100px auto 0px;">
                            <div class="card">
                                <div class="card-body">
                                    <a class="btn btn-sm btn-primary" href="add-new-accounts.php">Add New Accounter</a>
                                    ...
                                    <?php
                                        $data =$AccountManagement -> viewdata();
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger" href="accounter-data-delete.php?id=<?php echo $single_data['Id'];?>">Delete</a>
                                        </td>
                                        </tr>
                                    </tbody>
                                    <?php endwhile; ?>
        ...
        <div class="modal-dialog" >
            <div class="modal-content" style="width:600px; height:600px;">
                <div class="model-header">
                    ...
                    <h3 class="model-title" style="margin-left: 40px;">Accounts Details</h3>
                </div>
                <div class="modal-body" id="accounts_detail">
                </div>
                <div></div>
            </div>
        </div>
        ...
        <div class="modal-dialog">  
            <div class="modal-content">  
                    <div class="modal-header">  
                        ...
                        <h4 class="modal-title">Update Accounts Info</h4>  
                    </div>  
                    <div class="modal-body">  
                        <form method="post" id="update_form">  
                            ...
                            <br />  
                            <input type="hidden" name="accounts_id" id="accounts_id" />  
...
$(document).ready(function(){  
      ...
      $('#update_form').on("submit", function(event){  
           ...
           {   
               ...
               var contact=$('#contact').val();
                $.ajax({  
                     url:"update-accounter-data.php",  
                     method:"POST",  
                     data:{id: accounts_id, fname: first_name, lname: last_name, email: email, contact: contact},  
                     beforeSend:function(){  
                          $('#update').val("updating");  
                     }, 
                     success:function(data){   
    ...
    $(document).on('click', '.view_data', function(){  
        ...
        {  
            $.ajax({  
                url:"view-single-accounter.php",  
                method:"POST",  
                data:{accounts_id:accounts_id},  
                success:function(data){   
                    $('#accounts_detail').html(data);
