    ...
    <section class="vbox">
        <section class="scrollable padder">
            <section class="row m-b-md">
                <div class="col-sm-6">
                    <h3 class="m-b-xs text-black">All Staff Data</h3> <small>Welcome back, John Smith</small> </div>
            </section>
                ...
                <div class="col-md-12 dker">
                    <section>
                        <div class= "main-section" style=" width:800px; margin:100px auto 0px;">
                            <div class="card">
                                <div class="card-body">
                                    <a class="btn btn-sm btn-primary" href="add-new-staff.php">Add New Staff</a>
        ...
        <div class="modal-dialog" >
            <div class="modal-content" style="width:600px; height:600px;">
                <div class="model-header">
                    ...
                    <h3 class="model-title" style="margin-left: 40px;">Staff Details</h3>
                </div>
      ...
      $('#update_form').on("submit", function(event){  
           ...
           {   
               ...
               var contact=$('#contact').val();
                $.ajax({  
                     url:"update-staff-data.php",  
                     method:"POST",  
                     data:{id: staff_id, fname: first_name, lname: last_name, email: email, contact: contact},  
                     beforeSend:function(){  
                          $('#update').val("updating");  
                     }, 
                     success:function(data){   
