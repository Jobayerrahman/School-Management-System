...
<section class="vbox">
        <section class="scrollable padder">
            <section class="row m-b-md">
                <div class="col-sm-6">
                    <h3 class="m-b-xs text-black">Add new admin</h3> <small>Welcome back, John Smith</small> </div>
            </section>
                ...
                <div class="col-md-12 dker">
                    <section>
                        <div class= "main-section" style=" width:800px; margin:10px auto 0px;">
                            <div class="card">
                                <div class="card-body">
                                    <a class="btn btn-primary" href="view-all-admin.php">View Admins</a>
                                    <br>
                                    <br>
                                    <?php
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $email_check = $AdminManagement -> emailCheck($email);
                                            ...
                                            {
                                                $data = $AdminManagement -> AddAdmin($first_name,$last_name,$email,$password,$contact,$unique_image_name);

                                                move_uploaded_file( $image_tmp_name, '../../assets/images/'. $unique_image_name);
                                                if($data == true)
                                                {
                                                    $mess = "<p class='alert alert-success'>A New Admin Added! !<button class='close' data-dismiss='alert'>&times;</button></p>";
                                                }
                                            }
                                        }
                                    ?>
